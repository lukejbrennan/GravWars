...
class DeathStar(pygame.sprite.Sprite):
	def __init__(self, gs):
		self.gs = gs
		self.image= pygame.image.load("/home/scratch/paradigms/deathstar/deathstar.png").convert() 
		self.rect = self.image.get_rect() 
		self.OG_image=pygame.image.load("/home/scratch/paradigms/deathstar/deathstar.png")
		self.angle =-80 
